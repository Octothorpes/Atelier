        ...
        <div className="image-modal-content">
          ...
          <div className="image-modal-body">
            <form>
              ...
              <textarea cols="40" rows="1" maxLength="60" placeholder="Example: jackson11!"></textarea>
              ...
              <textarea cols="40" rows="1" maxLength="60" placeholder="Example: jackson11@email.com"></textarea>
              <br></br>
          ...
          <div className="image-modal-footer">
            ...
            <button className="image-button" onClick={this.props.show}>submit</button>
          </div>
        </div>
      </div>
    );
