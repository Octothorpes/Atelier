    ...
    return (
      <React.Fragment>
        <div id="comfortChart">
          ...
          <div id="comfortChars">
            <span className="arrowChart arrowRating1">Uncomfortable</span>
            <span className="arrowChart arrowRating2">Ok</span>
            <span className="arrowChart arrowRating3">Comfortable</span>
          </div>
        </div>
      </React.Fragment>
    );
